    ...
    <section id="AboutMe" className="about--section">
      ...
      <div className="hero--section--content--box about--section--box">
        ...
        <p className="hero--section--description">
          ...
          abilities. Notable examples include 'House of Books,' demonstrating my
          proficiency in React, Redux, and automated hosting, and 'My Parking
          Assistant' highlighting my web development skills with Node.js,
          MongoDB. Beyond my technical expertise, I've contributed to the
          academic community as a Graduate Peer Leader at Stevens Institute,
          providing mentorship and support to fellow students.
        </p>
      </div>
    </section>
  );
